...
export function CcsFrameworkCard({ framework }: { framework: CcsRequirementsFramework }) {
  return (
    <section className="rounded-2xl border border-amber-500/20 bg-slate-50 dark:bg-slate-900/50 p-6">
      ...
      <p className="mt-2 text-sm text-amber-900 dark:text-amber-100/80">{framework.ccs_ge_note}</p>

      <div className="mt-6 grid gap-6 md:grid-cols-2">
        <div>
          <h3 className="text-xs font-semibold uppercase tracking-wider text-amber-700 dark:text-amber-300/80">
