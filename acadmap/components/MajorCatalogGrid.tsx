      ...
      {majors.map((major) => (
        <li key={major.slug}>
          <Link
            ...
            className="card-glow group flex h-full flex-col rounded-2xl border border-indigo-500/25 bg-white dark:bg-slate-900/60 p-5 transition hover:border-violet-400/40 hover:bg-white/95 dark:bg-slate-900/90"
          >
            <div className="mb-3 flex items-start justify-between gap-2">
              <span className="rounded-lg bg-indigo-500/20 px-2.5 py-1 text-[10px] font-bold uppercase tracking-wider text-indigo-800 dark:text-indigo-200 ring-1 ring-indigo-400/25">
                {major.degree_type}
              </span>
              {major.roadmap_available ? (
                ...
                <span className="rounded-full bg-indigo-500/15 px-2 py-0.5 text-[10px] font-bold uppercase text-indigo-800 dark:text-indigo-200">
                  GEAR detail
                </span>
                ...
                <span className="rounded-full bg-teal-500/15 px-2 py-0.5 text-[10px] font-bold uppercase text-teal-800 dark:text-teal-200">
                  Full requirements
                </span>
            ...
            <h3 className="text-lg font-semibold text-slate-900 dark:text-slate-50 group-hover:text-indigo-900 dark:text-indigo-100">
              {major.name}
            </h3>
            ...
            <span className="mt-auto pt-4 inline-flex items-center gap-1 text-sm font-medium text-indigo-700 dark:text-indigo-300 transition group-hover:gap-2 group-hover:text-violet-800 dark:text-violet-200">
              {ctaLabel}
